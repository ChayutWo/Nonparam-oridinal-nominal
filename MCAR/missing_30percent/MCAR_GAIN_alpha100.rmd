...
---
title: "Testing different imputation methods on PUMS (MCAR) - Generative Adversarial Imputation Nets (GAIN)"
output:
...
d1 = read.csv('../../GAIN/imputed_dataset/MCAR_PUMS01_30percent_alpha100_1.csv', header = FALSE, sep = ',')
d2 = read.csv('../../GAIN/imputed_dataset/MCAR_PUMS01_30percent_alpha100_2.csv', header = FALSE, sep = ',')
d3 = read.csv('../../GAIN/imputed_dataset/MCAR_PUMS01_30percent_alpha100_3.csv', header = FALSE, sep = ',')
d4 = read.csv('../../GAIN/imputed_dataset/MCAR_PUMS01_30percent_alpha100_4.csv', header = FALSE, sep = ',')
d5 = read.csv('../../GAIN/imputed_dataset/MCAR_PUMS01_30percent_alpha100_5.csv', header = FALSE, sep = ',')
