...
xtable(summary, caption = 'Distribution of coverage for different imputation methods, and the premissing data with 30% values MAR (Marginal probabilities)', digits = 2)
```
...
summary = apply(df, MARGIN = 2, quantile , probs = c(0, 0.25, 0.5, 0.75, 1), na.rm = TRUE)
rownames(summary) <- c('Min.', '1st Qu.', 'Median', '3rd Qu.', 'Max.')
xtable(summary, caption = 'Distribution of coverage for different imputation methods, and the premissing data with 30% values MAR (Bivariate probabilities)', digits = 2)
```
...
summary = apply(df, MARGIN = 2, quantile , probs = c(0, 0.25, 0.5, 0.75, 1), na.rm = TRUE)
rownames(summary) <- c('Min.', '1st Qu.', 'Median', '3rd Qu.', 'Max.')
xtable(summary, caption = 'Distribution of coverage for different imputation methods, and the premissing data with 30% values MAR (Trivariate probabilities)', digits = 2)
```
