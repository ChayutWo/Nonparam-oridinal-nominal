...
def gain (data_x, num_imputations, gain_parameters, filename = 'imputed'):
  ...
  """
  Boat comments:
   - How to represent ordinal data for output? (min-max normalization and imply thresholding?)
   - Need to adjust renormalization and rounding function at the end
  """
  ...
  def generator(x,m):
    ...
    # Boat comments: they use sigmoid here because the output is between 0 to 1
  ...
  ## index to save file
  imputation_index = num_imputations
