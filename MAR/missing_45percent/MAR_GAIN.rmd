...
---
title: "Testing different imputation methods on PUMS (MAR) - Generative Adversarial Imputation Nets (GAIN)"
output:
...
d1 = read.csv('../../GAIN/imputed_dataset/MAR_PUMS01_45percent_1.csv', header = FALSE, sep = ',')
d2 = read.csv('../../GAIN/imputed_dataset/MAR_PUMS01_45percent_2.csv', header = FALSE, sep = ',')
d3 = read.csv('../../GAIN/imputed_dataset/MAR_PUMS01_45percent_3.csv', header = FALSE, sep = ',')
d4 = read.csv('../../GAIN/imputed_dataset/MAR_PUMS01_45percent_4.csv', header = FALSE, sep = ',')
d5 = read.csv('../../GAIN/imputed_dataset/MAR_PUMS01_45percent_5.csv', header = FALSE, sep = ',')
